        ...
        {inviteResult ? (
          <div className="space-y-5">
            ...
            <div>
              ...
              <a
                href={`https://wa.me/${phone.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(`Hi! You've been invited to RentFlow. Click the link to activate your account:\n\n${inviteResult.invitation_link}`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 text-white rounded-xl text-xs font-bold hover:bg-emerald-700 transition-all"
              >
